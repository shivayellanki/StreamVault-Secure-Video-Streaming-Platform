...
app.post(
  ...
  async (req, res) => {
    ...
    const ffmpegCmd = `ffmpeg -i ${videoPath} -c:v copy -threads 1 -codec:a aac -hls_time 10 -hls_playlist_type vod -hls_key_info_file ${keyInfoPath} -hls_segment_filename "${outputPath}/segment%03d.ts" -start_number 0 ${hlsPath}`;
